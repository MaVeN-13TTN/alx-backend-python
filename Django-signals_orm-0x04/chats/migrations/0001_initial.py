    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'db_table': 'messages',
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['conversation', '-created_at'], name='messages_convers_38b855_idx'), models.Index(fields=['sender', '-created_at'], name='messages_sender__7375e3_idx')],
            },
        ),
    ]
